    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Acceso para Docentes</h1>
        </header>
              ...
              <div class="s-12 m-12 l-6">
                ...
                <form class="customform" method="post">
					...
					<?php
						...
						if (isset($returnUrl)) {
							$error = "Para entrar necesitas loguearte";
					?>
                  ...
                  <div class="line">
                    <div class="margin">
                      <div class="s-12 m-12 l-6">                
                        <input name="loginemail" class="required email border-radius" placeholder="Su nombre de usuario" title="Su nombre de usuario" type="text" value="<?php echo addslashes($_POST['loginemail']); ?>" />
                      </div>
                      <div class="s-12 m-12 l-6">
                        <input name="loginpassword" class="name border-radius" placeholder="Su contraseña" title="Su contraseña" type="password" value="<?php echo addslashes($_POST['loginpassword']); ?>" />
                      </div>
                    </div>
                  </div>
                 
                 
                  <div class="s-12 m-12 l-4"><button class="submit-form button background-primary border-radius text-white" name= "submit" type="submit" value="Acceder">Acceder</button></div> 
                </form>
